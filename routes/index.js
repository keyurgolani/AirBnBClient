...
router.get('/adminDashboard', function(req, res, next) {
	async.parallel([function(callback) {
		...
		mysql.executeQuery("select property_details.city, trip_details.checkin, sum(trip_details.trip_amount) as revenue from property_details left join listings on property_details.property_id = listings.property_id left join trip_details on listings.listing_id = trip_details.listing_id where trip_details.checkout between '2016-01-01' and '2016-12-31' group by property_details.city order by revenue DESC ", [], function(error, results) {
			if(error) {
				callback(error, null);
			} else {
				callback(null, results);
...
router.get('/profile', function(req, res, next) {
	...
	async.parallel([
		function(callback) {
			mq_client.make_request('fetch_profile', {
				'payload' : req.query.owner
		...
		function(callback) {
			mq_client.make_request('fetch_card_details', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_login_history', {
				'payload' : req.query.owner
			}, function(err,results){
		...
		function(callback) {
			mq_client.make_request('fetch_properties', {
				'payload' : req.query.owner
			}, function(err,results){
				//console.log("err,results", err,results);
				if(err){
		...
		function(callback) {
			mq_client.make_request('fetch_listings', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_trips', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_hostings', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_user_photo', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_user_video', {
				'payload' : req.query.owner
			}, function(err,results){
				if(err){
					throw err;
		...
		function(callback) {
			mq_client.make_request('fetch_host_rating_details', {
				'payload' : req.query.owner
			}, function(err,results){
				//console.log("err,results", err,results);
				if(err){
		...
		function(callback) {
			mq_client.make_request('fetch_traveller_rating_details', {
				'payload' : req.query.owner
			}, function(err,results){
				//console.log("err,results", err,results);
				if(err){
